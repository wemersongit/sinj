...
{
    public class UtilBuscaPendenteDePublicacaoEs
    {
        ...
        public void MontarFiltroBuscaGeral(string[] filtros, BuscaPendenteDePublicacaoEs buscaPendenteDeEnvioEs)
        {
            ...
            if (filtros != null)
            {
                ...
                foreach (var _filtro in filtros)
                {
                    ...
                    buscaPendenteDeEnvioEs.filtersToQueryString.Add(filterQueryString);
                }
            }
        }
    }
