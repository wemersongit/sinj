...
namespace util.BRLight {
    ...
    {
        public FalhaOperacaoException(string msg) : base(msg) { }
        public FalhaOperacaoException(Exception ex) : base("Falha na operação", ex) { }
        public FalhaOperacaoException(string msg, Exception ex) : base(msg, ex){}
    }
