...
namespace util.BRLight
{
    ...
    public class Relatorio
    {
        ...
        {
            return  newCell( sTexto, fFont, iColsspan, iHorizontalAlignment, iVerticalAlignment, headerwidth, bAddGlossario, sTema, -1 );
        }
 
        public PdfPCell newCell(string sTexto, Font fFont, int iColsspan, int iHorizontalAlignment, int iVerticalAlignment, float headerwidth, bool bAddGlossario, string sTema,int iBorder)
        {
            try
            {
        ...
        {
            return newCell(sTexto, fFont, iColsspan, iRowspan, iHorizontalAlignment, iVerticalAlignment, headerwidth, bAddGlossario, sTema, -1);
        }

        public PdfPCell newCell(string sTexto, Font fFont, int iColsspan, int iRowspan, int iHorizontalAlignment, int iVerticalAlignment, float headerwidth, bool bAddGlossario, string sTema, int iBorder)
        {
            try
            {
                var cell = new PdfPCell();
