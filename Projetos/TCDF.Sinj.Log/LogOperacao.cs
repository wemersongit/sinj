...
namespace TCDF.Sinj.Log
{
    public class LogOperacao <T>
    {
        ...
        public static ulong gravar_operacao(string _ch_operacao, LogIncluir<T> incluir, string nm_user, string nm_login_user)
        {
        ...
        public static ulong gravar_operacao(string _ch_operacao, LogArquivo<T> arquivo, string nm_user, string nm_login_user)
        {
            var operacao = new LogOperacaoOV<LogArquivo<T>> { ch_tipo_operacao = "incluir", operacao = arquivo };
            return gravar_operacao(_ch_operacao, JSON.Serialize<LogOperacaoOV<LogArquivo<T>>>(operacao), 0, nm_user, nm_login_user);
        }

        public static ulong gravar_operacao(string _ch_operacao, LogAlterar<T> alterar, ulong _id_doc_origem, string nm_user, string nm_login_user)
        {
        ...
        public static ulong gravar_operacao(string _ch_operacao, LogPutPath<T> putPath, ulong _id_doc_origem, string nm_user, string nm_login_user)
        {
        ...
        public static ulong gravar_operacao(string _ch_operacao, LogExcluir<T> excluir, string nm_user, string nm_login_user)
        {
            var operacao = new LogOperacaoOV<LogExcluir<T>> { ch_tipo_operacao = "excluir", operacao = excluir };
            return gravar_operacao(_ch_operacao, JSON.Serialize<LogOperacaoOV<LogExcluir<T>>>(operacao), 0, nm_user, nm_login_user);
        }
