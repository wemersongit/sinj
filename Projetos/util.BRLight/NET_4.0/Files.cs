...
namespace util.BRLight
{
    public static class Files
    {
        ...
        public static int CriaArquivo(string pathArquivo, string stringArquivo) {
            return  CriaArquivo(pathArquivo, stringArquivo, false, Encoding.Default);
        }

        public static int CriaArquivo(string pathArquivo, string stringArquivo, bool append)
        {
            return CriaArquivo(pathArquivo, stringArquivo, append, Encoding.Default);
        }

        public static int CriaArquivoNL(string pathArquivo, string stringArquivo, bool append)
        {
            TextWriter tw = null;
            ...
            try
            {
                ...
                tw.WriteLine(stringArquivo);
            }
            catch (Exception ex)
            {
                throw new Exception("CriaArquivoNL - " + pathArquivo, ex);
            }
            finally
            {
                if (tw != null)
        ...
        public static int CriaArquivo(string pathArquivo, string stringArquivo, bool append, Encoding e)
        {
            TextWriter tw = null;

            try {
                tw = new StreamWriter(pathArquivo, append, e);
