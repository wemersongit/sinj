...
namespace neo.BRLightSession
{
    public class Session {
        ...
        private void initIdSession()
        {
            id_session = Cookies.ReadCookie(cookieName);
            id_sessionLook = Cookies.ReadCookie(cookieNameLook);
        }

        private void createIdSession(bool manter_ativa)
        {
			var cok_id_session = Cookies.ReadCookie(cookieName);
            id_sessionLook = Guid.NewGuid().ToString();
            ...
            if (manter_ativa) {
                ...
                Cookies.WriteCookie(cookieNameLook, id_sessionLook, false, DateTime.Now.AddDays(timeout));
            } else {
                Cookies.WriteCookie(cookieName, cok_id_session, true);
                Cookies.WriteCookie(cookieNameLook, id_sessionLook, false);
            }

            id_session = cok_id_session;    
        }
