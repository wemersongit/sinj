<%@ Page Title="" Language="C#" MasterPageFile="~/Sinj.Master" AutoEventWireup="true" CodeBehind="EditarNorma.aspx.cs" Inherits="TCDF.Sinj.Web.EditarNorma" %>
        ...
        <div class="form">
            <form id="form_norma" name="formCadastroNorma" action="#" method="post">
                <div class="loaded" id="div_norma">
                        ...
                        <fieldset>
                            ...
                            <div class="mauto table">
                                <div class="line">
                                    ...
                                    <div class="column w-70-pc">
                                        <div id="div_tipo_norma" class="cell w-60-pc">
                                            ...
                                            <input id="in_g2" type="hidden" value="" />
                                ...
                                <div class="line">
                                    ...
                                    <div class="column w-70-pc">
                                        <div class="cell w-80-pc">
                                            <input id="nr_norma" name="nr_norma" type="text" value="" class="w-20-pc" label="Número" disabled="true" />
                                        </div>
                                    </div>
                                </div>
                                <div class="line">
                                    ...
                                    <div class="column w-70-pc">
                                        <div class="cell w-80-pc">
                                            <input id="cr_norma" name="cr_norma" type="text" value="" class="w-20-pc" disabled="true" />
                                        </div>
                                    </div>
                                </div>
                                <div class="line">
                                    ...
                                    <div class="column w-70-pc">
                                        <div class="cell w-80-pc">
                                            <input id="nr_sequencial" name="nr_sequencial" type="text" value="" class="w-20-pc" disabled="true" />
                                        </div>
                                    </div>
                                </div>
                                <div class="line">
                                ...
                                <div class="line">
                                    ...
                                    <div class="column w-70-pc">
                                        <div class="cell w-80-pc">
                                            <select label="Âmbito" obrigatorio="sim" id="id_ambito" name="id_ambito" disabled="true" />
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="column w-100-pc">
                                        <div class="cell w-100-pc">
                                            <div class="w-90-pc mauto">
                                                <button type="button" onclick="javascript:CriarModalOrigem();"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_add_p.png" />Adicionar Origem</button>
                                            </div>
                                            <table id="table_origens" class="w-90-pc mauto">
                               ...
                               { %>
                                ...
                                <div id="line_autorias" class="line">
                                    <div class="column w-100-pc">
                                        <div class="cell w-100-pc">
                                            <div class="w-90-pc mauto">
                                                <button type="button" onclick="javascript:CriarModalAutoria();"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_add_p.png" >Adicionar Autoria</button>
                                            </div>
                                ...
                                <div id="line_interessados" class="line">
                                    <div class="column w-100-pc">
                                        <div class="cell w-100-pc">
                                            <div class="w-90-pc mauto">
                                                <button type="button" onclick="javascript:CriarModalInteressado();"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_add_p.png" >Adicionar Interessado</button>
                                            </div>
                                ...
                                <div class="line">
                                    <div class="column w-100-pc">
                                        <div class="cell w-100-pc">
                                            <div class="w-90-pc mauto">
                                                <button type="button" onclick="javascript:CriarModalNome();"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_add_p.png" >Adicionar Nome</button>
                                            </div>
                            ...
                            <div class="mauto table">
                                <div class="line">
                                    <div class="column w-100-pc">
                                        <div class="cell w-100-pc">
                                            <div class="w-90-pc mauto">
                                                <button type="button" onclick="javascript:CriarModalFonte();"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_add_p.png" >Adicionar Fonte</button>
                                            </div>
                    ...
                    <div id="div_texto_atualizado" class="pos_cad">
                        <br />
                        <fieldset>
                            <legend>Texto Atualizado</legend>
                            <div class="mauto table">
                                <div class="line">
                                    <div class="column w-20-pc">
                                        <div class="cell fr">
                                    ...
                                    <div class="column w-70-pc">
                                        <div id="arquivo_atualizado" class="cell w-100-pc">
                                            <input type="hidden" id="hidden_json_arquivo_texto_atualizado" name="json_arquivo_texto_atualizado" class="json_arquivo" value="" />
                                            <label id="label_arquivo_texto_atualizado" class="name" style="color:#000;"></label>
                            ...
                            <div class="mauto table">
                                <div class="line">
                                    <div class="column w-100-pc">
                                        <div class="cell w-100-pc">
                                            <div class="w-90-pc mauto">
                                                <button type="button" onclick="javascript:CriarModalIndexacao();"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_add_p.png" >Adicionar Indexação</button>
                                            </div>
                            ...
                            <div class="mauto table">
                                <div class="line">
                                    <div class="column w-100-pc">
                                        <div class="cell w-100-pc">
                                            <div class="w-90-pc mauto">
                                                <button type="button" onclick="javascript:CriarModalDecisao();"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_add_p.png" >Adicionar Decisão</button>
                                            </div>
                                ...
                                <div class="line">
                                    ...
                                    <div class="column w-70-pc">
                                        <div class="cell w-100-pc">
                                            <input name="ds_parametro_constitucional" type="text" value="" class="w-50-pc" />
                                        </div>
                                    </div>
                                </div>
                                <div class="line">
                                    <div class="column w-100-pc">
                                        <div class="cell w-100-pc">
                                            <div class="w-90-pc mauto">
                                                <button type="button" onclick="javascript:CriarModalRequerente();"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_add_p.png" >Adicionar Requerente</button>
                                            </div>
                                ...
                                <div class="line">
                                    <div class="column w-100-pc">
                                        <div class="cell w-100-pc">
                                            <div class="w-90-pc mauto">
                                                <button type="button" onclick="javascript:CriarModalRequerido();"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_add_p.png" >Adicionar Requerido</button>
                                            </div>
                                ...
                                <div class="line">
                                    <div class="column w-100-pc">
                                        <div class="cell w-100-pc">
                                            <div class="w-90-pc mauto">
                                                <button type="button" onclick="javascript:CriarModalProcurador();"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_add_p.png" >Adicionar Procurador</button>
                                            </div>
                                ...
                                <div class="line">
                                    <div class="column w-100-pc">
                                        <div class="cell w-100-pc">
                                            <div class="w-90-pc mauto">
                                                <button type="button" onclick="javascript:CriarModalRelator();"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_add_p.png" >Adicionar Relator</button>
                                            </div>
