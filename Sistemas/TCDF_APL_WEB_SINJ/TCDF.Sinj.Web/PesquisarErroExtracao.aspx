<%@ Page Title="" Language="C#" MasterPageFile="~/Sinj.Master" AutoEventWireup="true" CodeBehind="PesquisarErroExtracao.aspx.cs" Inherits="TCDF.Sinj.Web.PesquisarErroExtracao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <div class="divIdentificadorDePagina">
	    <label>.: Pesquisar Erro de Extração</label>
	</div>
    ...
    <div class="form">
        <form id="form_pesquisa_erro_extracao" name="formPesquisaErroExtracao" action="./ResultadoDePesquisaErroExtracao.aspx" method="get">
            <div id="div_pesquisa">
                <fieldset>
