...
{
    /// <summary>
    /// Summary description for RequerenteDatatable
    /// </summary>
    public class RequerenteDatatable : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var action = AcoesDoUsuario.rqe_pes;
            ...
            try
            {
                ...
                json_resultado = new RequerenteRN().JsonReg(pesquisa);
