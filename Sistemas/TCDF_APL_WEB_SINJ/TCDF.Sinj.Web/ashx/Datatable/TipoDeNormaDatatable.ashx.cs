...
{
    /// <summary>
    /// Summary description for TipoDeNormaDatatable
    /// </summary>
    public class TipoDeNormaDatatable : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var action = AcoesDoUsuario.tdn_pes;
            ...
            try
            {
                ...
                json_resultado = new TipoDeNormaRN().JsonReg(pesquisa);
