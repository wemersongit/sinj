...
{
    /// <summary>
    /// Summary description for TipoDePublicacaoDatatable
    /// </summary>
    public class TipoDePublicacaoDatatable : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var action = AcoesDoUsuario.tdp_pes;
            ...
            try
            {
                ...
                json_resultado = new TipoDePublicacaoRN().JsonReg(pesquisa);
