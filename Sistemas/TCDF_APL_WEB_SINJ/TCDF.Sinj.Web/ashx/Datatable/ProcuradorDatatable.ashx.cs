...
{
    /// <summary>
    /// Summary description for ProcuradorDatatable
    /// </summary>
    public class ProcuradorDatatable : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var action = AcoesDoUsuario.pro_pes;
            ...
            try
            {
                ...
                json_resultado = new ProcuradorRN().JsonReg(pesquisa);
