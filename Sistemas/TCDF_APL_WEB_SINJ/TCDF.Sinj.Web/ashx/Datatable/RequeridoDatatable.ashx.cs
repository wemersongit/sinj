...
{
    /// <summary>
    /// Summary description for RequeridoDatatable
    /// </summary>
    public class RequeridoDatatable : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var action = AcoesDoUsuario.rqi_pes;
            ...
            try
            {
                ...
                json_resultado = new RequeridoRN().JsonReg(pesquisa);
