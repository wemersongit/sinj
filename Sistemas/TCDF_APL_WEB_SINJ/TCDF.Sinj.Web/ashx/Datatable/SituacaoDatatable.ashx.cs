...
{
    /// <summary>
    /// Summary description for SituacaoDatatable
    /// </summary>
    public class SituacaoDatatable : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var action = AcoesDoUsuario.sit_pes;
            ...
            try
            {
                ...
                json_resultado = new SituacaoRN().JsonReg(pesquisa);
