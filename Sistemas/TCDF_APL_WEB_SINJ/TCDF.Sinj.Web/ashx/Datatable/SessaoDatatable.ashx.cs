...
{
    /// <summary>
    /// Summary description for SessaoDatatable
    /// </summary>
    public class SessaoDatatable : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    pesquisa.literal += (!string.IsNullOrEmpty(pesquisa.literal) ? " AND " : "") + "id_session like '%" + (_app == "push" ? "pushlogin" : "usuariologin" ) + "'";
                }
                ...
                json_resultado = new SessaoRN().jsonReg(pesquisa);
