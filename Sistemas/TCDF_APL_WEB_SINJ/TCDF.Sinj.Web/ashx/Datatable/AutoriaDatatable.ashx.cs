...
{
    /// <summary>
    /// Summary description for AutoriaDatatable
    /// </summary>
    public class AutoriaDatatable : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var action = AcoesDoUsuario.aut_pes;
            ...
            try
            {
                ...
                json_resultado = new AutoriaRN().JsonReg(pesquisa);
