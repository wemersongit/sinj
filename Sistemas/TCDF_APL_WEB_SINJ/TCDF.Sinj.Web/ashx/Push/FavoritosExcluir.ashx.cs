...
{
    /// <summary>
    /// Summary description for FavoritosExcluir
    /// </summary>
    public class FavoritosExcluir : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(_ch))
                {
                    ...
                    {
                        notifiquemeOv.favoritos.Remove(_ch);
                        ...
                        {
                            throw new Exception("Erro ao desmarcar favoritos " + _ch);
                        }
                    }
                }
                else
