...
{
    /// <summary>
    /// Summary description for TipoDePublicacaoDetalhes
    /// </summary>
    public class TipoDePublicacaoDetalhes : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    sRetorno = JSON.Serialize<TipoDePublicacaoOV>(tipoDePublicacaoOv);
                }
                else
                {
