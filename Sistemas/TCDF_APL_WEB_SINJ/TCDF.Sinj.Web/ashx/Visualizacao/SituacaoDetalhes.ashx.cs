...
{
    /// <summary>
    /// Summary description for SituacaoDetalhes
    /// </summary>
    public class SituacaoDetalhes : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var action = AcoesDoUsuario.sit_vis;
            ...
            try
            {
                ...
                else if (!string.IsNullOrEmpty(_ch_situacao))
                {
                    situacaoOv = situacaoRn.Doc(_ch_situacao);
                }
                else
                {
                ...
                if (situacaoOv != null)
                {
                    sRetorno = JSON.Serialize<SituacaoOV>(situacaoOv);
                }
                else
                {
