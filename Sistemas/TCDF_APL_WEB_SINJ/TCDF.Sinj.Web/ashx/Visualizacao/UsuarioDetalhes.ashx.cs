...
{
    /// <summary>
    /// Summary description for UsuarioDetalhes
    /// </summary>
    public class UsuarioDetalhes : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var action = AcoesDoUsuario.usr_vis;
            ...
            try
            {
                ...
                else if (!string.IsNullOrEmpty(_ch_usuario))
                {
                ...
                if (usuarioOv != null)
                {
                    sRetorno = JSON.Serialize<UsuarioOV>(usuarioOv);
                }
                else
                {
