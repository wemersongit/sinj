...
{
    /// <summary>
    /// Summary description for NormaDesabilitarEmail
    /// </summary>
    public class NormaDesabilitarEmail : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(_id_doc) && ulong.TryParse(_id_doc, out id_doc))
                {
                    ...
                    {
                        sRetorno = "{\"id_doc_success\":" + id_doc + ",\"update\":true, \"st_habilita_email\":\"" + normaOv.st_habilita_email + "\" }";
                    }
                    else
                    {
