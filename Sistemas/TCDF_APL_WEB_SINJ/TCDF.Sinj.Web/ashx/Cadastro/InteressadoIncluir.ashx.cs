...
{
    /// <summary>
    /// Summary description for InteressadoIncluir
    /// </summary>
    public class InteressadoIncluir : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var action = AcoesDoUsuario.int_inc;
            ...
            try
            {
                ...
                interessadoOv.nm_login_usuario_cadastro = sessao_usuario.nm_login_usuario;
                interessadoOv.dt_cadastro = DateTime.Now.ToString("dd'/'MM'/'yyyy HH:mm:ss");
                var id_doc = new InteressadoRN().Incluir(interessadoOv);
                if (id_doc > 0)
                {
                ...
                var log_incluir = new LogIncluir<InteressadoOV>
                {
