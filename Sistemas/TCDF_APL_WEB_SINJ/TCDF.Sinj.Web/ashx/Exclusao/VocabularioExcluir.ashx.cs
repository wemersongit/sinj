...
{
    /// <summary>
    /// Summary description for VocabularioExcluir
    /// </summary>
    public class VocabularioExcluir : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var _force = context.Request["force"];
            var force = false;
            bool.TryParse(_force, out force);
            ...
            try
            {
                if (ulong.TryParse(_id_doc, out id_doc))
                {
                    ...
                    var vocabularioOv = vocabularioRn.JsonReg(id_doc);
                    if (vocabularioRn.Excluir(id_doc, force))
                    {
                        ...
                        try
                        {
                            ...
                            excluidoOv.json_doc_excluido = vocabularioOv;
                            excluidoOv.nm_base_excluido = Config.ValorChave("NmBaseVocabulario", true);
