...
{
    /// <summary>
    /// Summary description for InteressadoExcluir
    /// </summary>
    public class InteressadoExcluir : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            ulong id_doc = 0;
            var action = AcoesDoUsuario.tdp_exc;
            ...
            try
            {
                if (ulong.TryParse(_id_doc, out id_doc))
                {
                    ...
                    var interessadoOv = new InteressadoRN().JsonReg(id_doc);
                    if (new InteressadoRN().Excluir(id_doc))
                    {
                        ...
                        try
                        {
                            ...
                            excluidoOv.json_doc_excluido = interessadoOv;
                            excluidoOv.nm_base_excluido = Config.ValorChave("NmBaseInteressado", true);
