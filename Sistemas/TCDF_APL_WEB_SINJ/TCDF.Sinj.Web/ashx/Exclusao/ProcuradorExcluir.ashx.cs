...
{
    /// <summary>
    /// Summary description for ProcuradorExcluir
    /// </summary>
    public class ProcuradorExcluir : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            ulong id_doc = 0;
            var action = AcoesDoUsuario.pro_exc;
            ...
            try
            {
                if (ulong.TryParse(_id_doc, out id_doc))
                {
                    ...
                    var procuradorOv = new ProcuradorRN().JsonReg(id_doc);
                    if (new ProcuradorRN().Excluir(id_doc))
                    {
                        ...
                        try
                        {
                            ...
                            excluidoOv.json_doc_excluido = procuradorOv;
                            excluidoOv.nm_base_excluido = Config.ValorChave("NmBaseProcurador", true);
