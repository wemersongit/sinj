...
{
    /// <summary>
    /// Summary description for TipoDeFonteExcluir
    /// </summary>
    public class TipoDeFonteExcluir : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                if (ulong.TryParse(_id_doc, out id_doc))
                {
                    ...
                    var tipoDeFonteRv = new TipoDeFonteRN().JsonReg(id_doc);
                    if (new TipoDeFonteRN().Excluir(id_doc))
                    {
                        ...
                        try
                        {
                            ...
                            excluidoOv.json_doc_excluido = tipoDeFonteRv;
                            excluidoOv.nm_base_excluido = Config.ValorChave("NmBaseTipoDeFonte", true);
