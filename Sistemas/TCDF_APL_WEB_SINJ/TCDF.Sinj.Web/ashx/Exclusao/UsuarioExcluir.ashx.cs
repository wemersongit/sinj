...
{
    /// <summary>
    /// Summary description for UsuarioExcluir
    /// </summary>
    public class UsuarioExcluir : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            ulong id_doc = 0;
            var action = AcoesDoUsuario.usr_exc;
            ...
            try
            {
                if (ulong.TryParse(_id_doc, out id_doc))
                {
                    ...
                    var usuarioOv = new UsuarioRN().JsonReg(id_doc);
                    if (new UsuarioRN().Excluir(id_doc))
                    {
                        ...
                        try
                        {
                            ...
                            excluidoOv.json_doc_excluido = usuarioOv;
                            excluidoOv.nm_base_excluido = Config.ValorChave("NmBaseUsuario", true);
