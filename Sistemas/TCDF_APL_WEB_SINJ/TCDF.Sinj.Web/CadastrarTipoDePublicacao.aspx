<%@ Page Title="" Language="C#" MasterPageFile="~/Sinj.Master" AutoEventWireup="true" CodeBehind="CadastrarTipoDePublicacao.aspx.cs" Inherits="TCDF.Sinj.Web.CadastrarTipoDePublicacao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <div class="divIdentificadorDePagina">
	    <label>.: Cadastrar Tipo de Publicação</label>
	</div>
    <div id="div_controls" class="control">
    </div>
    <div class="form">
        <form id="form_tipo_de_publicacao" name="formCadastroTipoDePublicacao" action="#" method="post">
