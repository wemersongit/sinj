<%@ Page Title="" Language="C#" MasterPageFile="~/Sinj.Master" AutoEventWireup="true" CodeBehind="DetalhesDeRequerente.aspx.cs" Inherits="TCDF.Sinj.Web.DetalhesDeRequerente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <div class="divIdentificadorDePagina">
	    <label>.: Detalhes de Requerente</label>
	</div>
    <div id="div_controls" class="control">
    </div>
    <div class="form">
        <div id="div_requerente" class="loaded">
                ...
                <div class="mauto table">
                    <div class="line">
                        ...
                        <div class="column w-70-pc">
                            <div id="div_nm_requerente" class="cell w-60-pc">
                            </div>
                        </div>
                    </div>
                    <div class="line">
                        ...
                        <div class="column w-70-pc">
                            <div id="div_ds_requerente" class="cell w-60-pc">
                            </div>
                        </div>
                    </div>
