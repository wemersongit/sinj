<%@ Page Title="" Language="C#" MasterPageFile="~/Sinj.Master" AutoEventWireup="true" CodeBehind="CadastrarTipoDeRelacao.aspx.cs" Inherits="TCDF.Sinj.Web.CadastrarTipoDeRelacao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <div class="form">
        <form id="form_tipo_de_relacao" name="formCadastroTipoDeRelacao" action="#" method="post">
                ...
                <fieldset class="w-60-pc">
                    ...
                    <div class="mauto table">
                        ...
                        <div class="line">
                            ...
                            <div class="column w-70-pc">
                                <div class="cell w-60-pc">
                                    <input id="in_selecionavel" name="in_selecionavel" type="checkbox" value="1" checked="checked" />
                                </div>
                            </div>
                        </div>
                    </div>
