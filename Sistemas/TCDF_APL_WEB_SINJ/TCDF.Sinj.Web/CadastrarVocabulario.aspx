<%@ Page Title="" Language="C#" MasterPageFile="~/Sinj.Master" AutoEventWireup="true" CodeBehind="CadastrarVocabulario.aspx.cs" Inherits="TCDF.Sinj.Web.CadastrarVocabulario" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            SelecionarTipoDeTermo();
        });
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <div class="divIdentificadorDePagina">
	    <label>.: Cadastrar Vocabulário</label>
	</div>
                        ...
                        <div class="line">
                            ...
                            <div class="column w-70-pc">
                                <div class="cell w-60-pc">
                                    <select id="ch_tipo_termo" name="ch_tipo_termo" label="Tipo de Termo" obrigatorio="sim" onchange="javascript:SelecionarTipoDeTermo();">
                                        <option value=""></option>
                        ...
                        <div class="line no-hide">
                            ...
                            <div class="column w-70-pc">
                                <div class="cell w-100-pc">
	                                <input type="hidden" id="ch_orgao" name="ch_orgao" value="" />
                                    <input label="Termo" obrigatorio="sim" id="nm_termo" name="nm_termo" type="text" value="" class="w-90-pc"/>
                                    <a id="a_removerOrgaoAutoridade" style="display:none;" title="remover" href="javascript:void(0);" onclick="javascript:RemoverOrgaoAutoridade();"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_delete_p.png" alt="remover" /></a>
                                </div>
                            </div>
                        </div>
                        <div class="line AU">
                            <div class="column w-100-pc">
                                <div class="cell w-100-pc text-center" style="background-color:#CCC;">
	                                <a id="a_selecionar_origens" href="javascript:void(0);" onclick="javascript:ExpandirTabelaDeOrgaos();" class="expansible closed" >Selecionar Órgãos <img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_arrow_down.png"/></a>
	                                <div id="div_datatable_origens" style="display:none;" ></div>
                                </div>
                            </div>
                        </div>
                        <div class="line no-hide">
