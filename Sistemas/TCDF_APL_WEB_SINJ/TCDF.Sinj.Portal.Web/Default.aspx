...
//        })
        $(document).ready(function () {
            ...
            var _ch_chamado_fale_conosco = '<%= Request["ch_chamado_fale_conosco"] %>';
            var _ds_assunto_fale_conosco = '<%= Request["ds_assunto_fale_conosco"] %>';

            if (IsNotNullOrEmpty(_ch_chamado_fale_conosco)) {
                $('#ch_chamado_fale_conosco').val(_ch_chamado_fale_conosco);
                $('#div_fale_conosco h2').text("Resposta do E-mail - " + _ds_assunto_fale_conosco);
                                    ...
                                    <div class="mauto table w-100-pc" style="margin-top:20px;">
                                        <div class="line">
                                            <div class="column w-100-pc">
                                                ...
                                                <a href="javascript:void(0);" data-toggle="tooltip" title='Informe o número, tipo de norma, termo ou frase que deseja localizar nos atos normativos ou diários oficiais. Use as aspas para encontrar uma frase exata. Ex: “Restaurante comunitário”.' style="padding:3px;"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_help.png" alt="info" width="12px" height="12px" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                    ...
                                    <div class="mauto table w-100-pc">
                                        <div class="line">
                                            ...
                                            <div class="column w-80-pc">
                                                <input id="input_norma_all" name="all" type="text" value="" class="w-95-pc" /><a href="javascript:void(0);" data-toggle="tooltip" title='Informe palavras ou frases que deseja buscar nos normativos. Use as aspas para encontrar uma frase exata. Ex: “Restaurante comunitário”.' style="padding:3px;"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_help.png" alt="info" width="12px" height="12px" /></a>
                                            </div>
                                        </div>
                                        <div class="line">
                                            <div class="column w-20-pc">
                                        ...
                                        <div class="line">
                                            ...
                                            <div class="column w-80-pc">
                                                <input name="ano_assinatura" type="text" value="" class="w-20-pc" /><a href="javascript:void(0);" data-toggle="tooltip" title='Informe o ano de publicação da norma pretendida, com quatro dígitos.' style="padding:3px;"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_help.png" alt="info" width="12px" height="12px" /></a>
                                            </div>
                                        </div>
                                        <div class="line">
                                            <div class="column w-20-pc">
                                ...
                                <form id="form_pesquisa_diario" name="formPesquisaDiario" action="./ResultadoDePesquisa" method="get">
                                    ...
                                    <div class="mauto table w-100-pc">
                                        ...
                                        <div class="line">
                                            ...
                                            <div class="column w-80-pc">
                                                <input name="nr_diario" type="number" value="" class="w-20-pc" /><a href="javascript:void(0);" data-toggle="tooltip" title='Informe o número do diário.' style="padding:3px;"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_help.png" alt="info" width="12px" height="12px" /></a>
                                            </div>
                                        </div>
                                        <div class="line">
                                            <div class="column w-20-pc">
                                            ...
                                            <div class="column w-70-pc">
                                             ...
                                             <%--<select id="secao_diario" label="Seção" name="secao_diario">
                                               <option value=""></option>
                                               <option value="1">1</option>
                                               <option value="2">2</option>
                                               <option value="3">3</option>
                                               <option value="1, 2 e 3">1, 2 e 3</option>
                                            </select>--%>
                                        ...
                                        <div class="line">
                                            ...
                                            <div class="column w-80-pc">
                                                <input name="filetext" type="text" value="" class="w-90-pc" /><a href="javascript:void(0);" data-toggle="tooltip" title='Informe o assunto ou frase que queira localizar nos diários. Use as aspas para encontrar uma frase exata. Ex: “Restaurante comunitário”.' style="padding:3px;"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_help.png" alt="info" width="12px" height="12px" /></a>
                                            </div>
                                        </div>
                                        <div class="line">
                                            <div class="column w-20-pc">
                                            ...
                                            <div class="column w-80-pc">
                                                <div class="w-100-pc fl">
                                                    ...
                                                    <a href="javascript:void(0);" data-toggle="tooltip" title='Informe a data de publicação do diário. (dd/mm/aaaa).' style="padding:3px;"><img src="<%= TCDF.Sinj.Util._urlPadrao %>/Imagens/ico_help.png" alt="info" width="12px" height="12px" /></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div style="width:150px;" class="loaded fr">
