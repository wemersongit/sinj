...
namespace TCDF.Sinj.Web.ashx.Push
{
    ...
    public class NotifiquemeEditar : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var log_editar = new LogAlterar<NotifiquemeOV>
            {
                id_doc = id_doc,
                registro = notifiquemeOv
            };
            LogOperacao.gravar_operacao(Util.GetEnumDescription(action), log_editar, id_doc, sessaoNotifiquemeOv.nm_usuario_push, sessaoNotifiquemeOv.email_usuario_push);
