...
{
    /// <summary>
    /// Summary description for ErroExtracaoDatatable
    /// </summary>
    public class ErroExtracaoDatatable : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                json_resultado = new Log.RN.log_lbconverterRN().jsonReg(pesquisa);
                ...
                LogOperacao.gravar_operacao(Util.GetEnumDescription(action)+".EXT.PES", Busca, sessao_usuario.nm_usuario, sessao_usuario.nm_login_usuario);
            }
            catch (Exception ex)
            {
                ...
                {
                    LogErro.gravar_erro(Util.GetEnumDescription(action) + ".EXT.PES", erro, sessao_usuario.nm_usuario, sessao_usuario.nm_login_usuario);
                }
            }
