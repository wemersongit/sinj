    ...
    if (tipo_pesquisa == "geral") {
        ...
        $('#tabs_pesquisa').html(
            '<ul>' +
                ...
                '<li nm="cesta"><a class="aba" href="#div_cesta" onclick="javascript:ClicarAba(\'cesta\');">Cesta</a></li>' +
            '</ul>' +
            '<div id="div_resultado_diario" class="result_datatable"><div id="div_sort_diario" class="sort_datatable">Ordenar por <select table="datatable_diarios" name="select_order_diario" onchange="javascript:selectOrder(\'datatable_diarios\',this);"><option value="0,asc">Menor Relevância</option><option value="0,desc" selected="selected">Maior Relevância</option><option value="1,asc">Tipo (A-Z)</option><option value="1,desc">Tipo (Z-A)</option><option value="2,asc">Menor Número</option><option value="2,desc">Maior Número</option><option value="3,asc">Menor Seção</option><option value="3,desc">Maior Seção</option><option value="4,asc">Mais Antigos</option><option value="4,desc">Mais Recentes</option></select></div><div id="div_aggregations_diario" class="agg_datatable">' + montarFiltro("sinj_diario") + '</div><div id="div_datatable_diario" class="table_datatable"></div></div>' +
        //            '<div id="div_resultado_diario"><button type="button" class="filtro" onclick="javascript:MostrarFiltros(\'sinj_diario\');"><img alt="filtro" src="' + _urlPadrao + '/Imagens/ico_filter_p.png" /> Refinar pesquisa</button><div id="div_datatable_diario"></div></div>' +
            '<div id="div_cesta">' +
                '<ul>' +
