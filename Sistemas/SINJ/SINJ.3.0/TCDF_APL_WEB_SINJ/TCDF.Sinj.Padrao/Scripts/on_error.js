...
function f_Projeta_Error(sMsg, sUrl, sLine) {
    ...
    if (sMsg != "Uncaught Error: Error calling method on NPObject.") {
        if ((sMsg != "") && (sUrl != 'undefined') && (sUrl != "") && (sUrl != 'null'))
            if (typeof jQuery != 'undefined') $.ajax({ type: 'POST', url: './ashx/ErrorJS.ashx', data: e, jsonpCallback: "callback", dataType: "jsonp", cache: false, async: true, success: null, error: null, timeout: 9000 });
    }
