                ...
                try
                {
                    ...
                    if (notifiquemeOv != null)
                    {
                        ...
                        var corpo = "Foi solicitada uma recriação de senha para sua conta do Notifique-me SINJ.<br/>"+
                            "Para prosseguir clique no link:<br/><a href='" + TCDF.Sinj.Util.GetUriAndPath() + "/RecriarSenhaNotifiqueme.aspx?recriar=" + notifiquemeOv._metadata.id_doc + "A" + token + "' target='_blank' title='Recriar Senha Notifique-me'>Recriar Senha</a><br/>"+
