...
{
    /// <summary>
    /// Summary description for TipoDeEdicaoDatatable
    /// </summary>
    public class TipoDeEdicaoDatatable : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var action = AcoesDoUsuario.tdf_pes;
            ...
            try
            {
                ...
                json_resultado = new TipoDeEdicaoRN().JsonReg(pesquisa);
