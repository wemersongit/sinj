...
{
    /// <summary>
    /// Summary description for InteressadoDatatable
    /// </summary>
    public class InteressadoDatatable : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var action = AcoesDoUsuario.int_pes;
            ...
            try
            {
                ...
                json_resultado = new InteressadoRN().JsonReg(pesquisa);
