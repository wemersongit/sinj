...
{
    /// <summary>
    /// Summary description for RelatorDatatable
    /// </summary>
    public class RelatorDatatable : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var action = AcoesDoUsuario.rel_pes;
            ...
            try
            {
                ...
                json_resultado = new RelatorRN().JsonReg(pesquisa);
