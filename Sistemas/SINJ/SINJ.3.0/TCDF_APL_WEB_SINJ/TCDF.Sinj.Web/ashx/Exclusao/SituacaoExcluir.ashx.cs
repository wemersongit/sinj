...
{
    /// <summary>
    /// Summary description for SituacaoExcluir
    /// </summary>
    public class SituacaoExcluir : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                if (ulong.TryParse(_id_doc, out id_doc))
                {
                    ...
                    var situacaoOv = new SituacaoRN().JsonReg(id_doc);
                    if (new SituacaoRN().Excluir(id_doc))
                    {
                        ...
                        try
                        {
                            ...
                            excluidoOv.json_doc_excluido = situacaoOv;
                            excluidoOv.nm_base_excluido = Config.ValorChave("NmBaseSituacao", true);
