...
{
    /// <summary>
    /// Summary description for TipoDeNormaExcluir
    /// </summary>
    public class TipoDeNormaExcluir : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            ulong id_doc = 0;
            var action = AcoesDoUsuario.tdn_exc;
            ...
            try
            {
                if (ulong.TryParse(_id_doc, out id_doc))
                {
                    ...
                    var tipoDeNormaOv = new TipoDeNormaRN().JsonReg(id_doc);
                    if (new TipoDeNormaRN().Excluir(id_doc))
                    {
                        ...
                        try
                        {
                            ...
                            excluidoOv.json_doc_excluido = tipoDeNormaOv;
                            excluidoOv.nm_base_excluido = Config.ValorChave("NmBaseTipoDeNorma", true);
