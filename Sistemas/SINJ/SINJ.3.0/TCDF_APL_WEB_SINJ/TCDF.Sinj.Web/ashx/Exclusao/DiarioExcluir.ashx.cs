...
{
    /// <summary>
    /// Summary description for DiarioExcluir
    /// </summary>
    public class DiarioExcluir : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                if (ulong.TryParse(_id_doc, out id_doc))
                {
                    ...
                    var diarioOv = new DiarioRN().JsonReg(id_doc);
                    if (new DiarioRN().Excluir(id_doc))
                    {
                        ...
                        try
                        {
                            ...
                            excluidoOv.json_doc_excluido = diarioOv;
                            excluidoOv.nm_base_excluido = Config.ValorChave("NmBaseDiario", true);
