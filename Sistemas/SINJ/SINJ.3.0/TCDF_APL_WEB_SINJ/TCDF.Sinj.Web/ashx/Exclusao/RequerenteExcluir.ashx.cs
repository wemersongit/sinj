...
{
    /// <summary>
    /// Summary description for RequerenteExcluir
    /// </summary>
    public class RequerenteExcluir : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            ulong id_doc = 0;
            var action = AcoesDoUsuario.rqe_exc;
            ...
            try
            {
                if (ulong.TryParse(_id_doc, out id_doc))
                {
                    ...
                    var requerenteOv = new RequerenteRN().JsonReg(id_doc);
                    if (new RequerenteRN().Excluir(id_doc))
                    {
                        ...
                        try
                        {
                            ...
                            excluidoOv.json_doc_excluido = requerenteOv;
                            excluidoOv.nm_base_excluido = Config.ValorChave("NmBaseRequerente", true);
