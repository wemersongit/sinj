<%@ Page Title="" Language="C#" MasterPageFile="~/Sinj.Master" AutoEventWireup="true" CodeBehind="CadastrarUsuario.aspx.cs" Inherits="TCDF.Sinj.Web.CadastrarUsuario" %>
                        ...
                        <div class="line">
                            ...
                            <div class="column w-70-pc">
                                <div class="cell w-60-pc">
                                    <input label="Login" obrigatorio="sim" id="nm_login_usuario" name="nm_login_usuario" type="text" value="" class="w-60-pc" />
                                </div>
                            </div>
                        </div>
                        <div class="line">
                            ...
                            <div class="column w-70-pc">
                                <div class="cell w-60-pc">
                                    <input label="Nome" obrigatorio="sim" id="Text1" name="nm_usuario" type="text" value="" class="w-90-pc" />
                                </div>
                            </div>
                        </div>
                        <div class="line">
                        ...
                        <div class="line">
                            ...
                            <div class="column w-70-pc">
                                <div id="div_perfil" class="cell w-60-pc">
                                    ...
                                    <input id="nm_perfil" name="nm_perfil" type="text" value="" class="w-80-pc" onblur="javascript:SelecionarPerfil();" /><a title="Listar" id="a1"></a>
                                </div>
                            </div>
                        </div>
                        <div class="line">
