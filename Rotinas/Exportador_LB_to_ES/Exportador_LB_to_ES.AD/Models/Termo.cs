...
{
    public class TermoVocabularioControlado : IComparable
    {
        public TermoVocabularioControlado()
        {
            In_Ativo = true;
        ...
        public TermoVocabularioControlado ListaPai { get; set; }
        ...
        {
            return Nm_Termo.CompareTo(((TermoVocabularioControlado)obj).Nm_Termo);
        }
